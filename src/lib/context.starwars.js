...
Worked example — a reply that requests a stealth check (note the trailing blocks after the prose). The party names below (Veth, Daro) are format placeholders only — do NOT copy them; list this campaign's real party members instead:
...
\`\`\`party
[{"name":"Veth","role":"Scout","hpPct":80,"isActive":true},{"name":"Daro","role":"Soldier","hpPct":95,"isActive":false}]
\`\`\`
\`\`\`check
{"skill":"STEALTH","dc":15}
\`\`\`
