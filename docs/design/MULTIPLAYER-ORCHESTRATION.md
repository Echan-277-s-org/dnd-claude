...
| V1.P0 | `react-specialist` (coordinator-implemented) | `src/lib/session.js`, `src/components/Chat.jsx`, `src/lib/session.multiplayer.test.js` | **IN PROGRESS** — schema v2 + `applyPartyUpdate` move + activate Phase 0 unit tests | V1 start |
